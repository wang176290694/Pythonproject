...
if wenzi == None:
    ...
    ff.write(int(wenzi)+1)
wenzi = int(wenzi)
ff.close
msgbox('{},这是你第{}次打开此程序,{}'.format(tishiyu1,wenzi,tishiyu2), title='', image='ban.jpg')         #提示--------------------------------------------
'''
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if (mouse_x > 905) and (mouse_x < 1200) and (mouse_y > 525) and (mouse_y < 600):#十连--------------------------------------------------------------------------------
                        ...
                        if not wuqi1:
                            ...
                            msgboxx1535 = ('在六十抽以下出金{}发,60-69出金{}发,70-79出金{}发,80-89出金{}发'.format(d - liushichou - qishichou - bashichou - wuxingbaodi,liushichou,qishichou, bashichou))
                            msgboxx2 = ('歪了{}发，其中迪卢克{}发，刻晴{}发，七七{}发，莫娜{}发，提纳里{}发，琴{}发。'.format(p, b1, b2,b3, b4, b5,b6))
                            msgboxx3 = ('累计共抽中{}{}发。累计共抽中四星{}发，保底{}/{}发。'.format(prize1, d - p, po, ff, po))
                        ...
                        font1535 = fonting.render(msgboxx1535,True,green)
                    ...
                    if chr(event.key) == 'h':
                        ...
                        if musicplay:
                            ...
                            logoimage = screen.blit(musicing1, (1140,60))
                            pygame.display.flip()
                        msgbox('刷新成功',image = r'ban.jpg')
                    elif chr(event.key) == 'l':
                        size = weight, height = 1200, 600
                        screen = pygame.display.set_mode(size)
                        screen.fill((0, 0, 0))
                        msgboxx1 = ('歌曲列表')
                        msgboxx2 = ('1.镇守之森(Her Legacy·Hanachirusato·Time to say Farewell) 唱片集:原神2022线上音乐会')
                        msgboxx4 = ('2.何妄何执(雷电将军) 唱片集:原神2022线上音乐会')
                        msgboxx5 = ('3.捕风的异乡人 唱片集:原神2021线上音乐会')
                        msgboxx6 = ('4.璃月港-昼 唱片集:再临·璃月')
                        msgboxx7 = ('5.飞彩镌流年·海灯节2022 唱片集:再临·璃月')
                        msgboxx8 = ('6.甘雨(角色演示) 唱片集:原神2021线上音乐会')
                        msgboxx9 = ('6.温迪(角色演示) 唱片集:原神2021线上音乐会')
                        msgboxx10 = ('7.黑马唱歌1 唱片集:大佐影音')
                        msgboxx11 = ('8.黑马唱歌2 唱片集:大佐影音')
                        backing = ('返回')
                        fonting = pygame.font.Font('hk4e_zh-cn.ttf', 26)
