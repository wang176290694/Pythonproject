...
try:
    ...
    msgbox('哼，你是不是乱动我偷偷存在C盘里的文件了?',image = 'tishi.jpg')
import threading
import numpy
import ctypes
import zipping
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if (mouse_x > 905) and (mouse_x < 1200) and (mouse_y > 525) and (mouse_y < 600):#十连--------------------------------------------------------------------------------
                        ...
                        if not wuqi1:
                            if dingguiobject == 'wuqi':
                                ...
                                logoimage = screen.blit(picture1, (0, 0))
                                pygame.display.flip()
                                shenzhudinggui = True
                                while shenzhudinggui:
                                    for event in pygame.event.get():
                                        if event.type == pygame.MOUSEBUTTONDOWN:
                                            mouse_x, mouse_y = pygame.mouse.get_pos()
                                            if (mouse_x > 750) and (mouse_x < 900) and (mouse_y > 190) and (mouse_y < 380):
                                                buttoning =buttonbox(msg='确定要选择“苍古自由之誓”作为你的定轨武器吗？', title='oh shit', choices=('取消', '确定'), image='canggu.jpg')
                                                if buttoning == '确定':
                                                    ...
                                                    pass
                                            elif (mouse_x > 900) and (mouse_x < 1050) and (mouse_y > 190) and (mouse_y < 380):
                                                buttoning =buttonbox(msg='确定要选择“四风原典”作为你的定轨武器吗？', title='oh shit', choices=('取消', '确定'), image='sifeng.jpg')
                                                if buttoning == '确定':
                                                    shenzhudinggui = False
                                                    ...
                                                    pass
                                            elif (mouse_x > 1100) and (mouse_x < 1200) and (mouse_y > 0) and (mouse_y < 100):
                                                shenzhudinggui = False
                                                dingguiobject = 'wuqi'
                                                if musicplay:
                                                    logoimage = screen.blit(tupian, (0, 0))
                                ...
                                while shenzhudinggui:
                                    for event in pygame.event.get():
                                        if event.type == pygame.MOUSEBUTTONDOWN:
                                            mouse_x, mouse_y = pygame.mouse.get_pos()
                                            if (mouse_x > 1100) and (mouse_x < 1200) and (mouse_y > 0) and (mouse_y < 100):
                                                shenzhudinggui = False
                                                if musicplay:
                                                    logoimage = screen.blit(tupian, (0, 0))
                                                    logoimage = screen.blit(musicing2, (1140,60))
                                                    ...
                                                    pygame.display.flip()
                                                pygame.display.flip()
                                            elif (mouse_x > 800) and (mouse_x < 1000) and (mouse_y > 450) and (mouse_y < 510):
                                                buttoning =buttonbox(msg='确定要取消定轨吗？', title='oh shit', choices=('取消', '确定'))
                                                if buttoning == '确定':
                                                    shenzhudinggui = False
                                                    dingguiobject = 'wuqi'
                                                    dinggui = 0
                    ...
                    try:
                        if chr(event.key) == 'h':
                            ...
                            screen = pygame.display.set_mode(size)
                            screen.fill((0, 0, 0))
                            msgboxx1 = ('what is new in Genshen 1.2')
                            msgboxx2 = ('完善了定轨功能,新增了意见反馈')
                            msgboxx3 = ('帮助:')
                            ...
                            fonte = fonting.render(msgboxxe, True, (255,255,0))
                            screen.blit(font1, (30, 30))
                                    ...
                                    if event.type == pygame.MOUSEBUTTONDOWN:
                                        ...
                                        if (mouse_x > 1090) and (mouse_x < 1200) and (mouse_y > 0) and (mouse_y < 100):#退出历史记录查看----------------------------------------
                                            ...
                                            if musicplay:
                                                ...
                                                logoimage = screen.blit(musicing1, (1140,60))
                                                pygame.display.flip()
                                        elif (mouse_x > 1030) and (mouse_x < 1200) and (mouse_y > 530) and (mouse_y < 600):
                                            saveas = textbox(msg='请输入你的意见', title='意见反馈', text='写点什么......', codebox=1)
                                            if saveas == '写点什么......' or saveas == None:
                                                pass
                                            else:
                                                ...
                                                ff.write('\n')
                                                ff.close()
                                                msgbox('感谢您的反馈，我们将持续改进！',image = 'ban.jpg')
